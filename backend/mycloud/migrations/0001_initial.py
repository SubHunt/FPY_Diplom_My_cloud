    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.FileField(upload_to=mycloud.models.path_to_file, verbose_name='Путь к файлу')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mycloud.user', verbose_name='Пользователь')),
            ],
        ),
    ]
