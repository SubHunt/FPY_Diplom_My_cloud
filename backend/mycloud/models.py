...
class Files(models.Model):
    ...
    link_download = models.URLField(max_length=50, unique=True, blank=True, verbose_name="Прямая ссылка")
    path = models.FileField(upload_to=path_to_file, verbose_name='Путь к файлу')
